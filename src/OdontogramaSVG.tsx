...
const OdontogramaSVG: React.FC<OdontogramaSVGProps> = ({ handleElementClick }) => {
  ...
  useEffect(() => {
    ...
    const svg = document.getElementById('odontograma') as SVGSVGElement;

    function crearDientes(dientes: { numero: number; dx: number }[], translateY: number, cuadrante: string) {
