...
const ConsentimientoProtesis: React.FC<ConsentimientoProtesisProps> = ({ doctor, patient }) => {
    ...
    <>
      ...
      <div id="consentimiento-print" className="consentimiento-form" ref={consentimientoRef}>
        ...
        <div className="compact-row">
          <p style={normalTextStyle}><strong>Doctor:</strong> {`${doctor.primerNombre} ${doctor.segundoNombre || ''} ${doctor.primerApellido} ${doctor.segundoApellido || ''}`}</p>
