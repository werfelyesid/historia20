...
const ConsentimientoEndodoncia: React.FC<ConsentimientoEndodonciaProps> = ({ doctorUid, patientUid }) => {
    ...
    <>
      ...
      <div id="consentimiento-print" className="consentimiento-form" ref={consentimientoRef}>
        ...
        <p style={normalTextStyle}>
          Se me ha explicado que el procedimiento de endodoncia recomendado para mi diente número {toothNumber} consiste en la eliminación de la pulpa dental infectada o dañada y en la posterior reconstrucción del diente utilizando materiales de restauración.
        </p>

        <h2>Riesgos y Complicaciones:</h2>
        <p style={normalTextStyle}>Entiendo que hay ciertos riesgos inherentes y potenciales asociados con los procedimientos de endodoncia, que incluyen, pero no se limitan a:</p>
        ...
        <p style={normalTextStyle}>
          El Dr. {doctor?.primerNombre || 'N/A'} {doctor?.segundoNombre || ''} {doctor?.primerApellido || 'N/A'} {doctor?.segundoApellido || ''} me ha explicado las alternativas al procedimiento de endodoncia, que incluyen no tratar el diente afectado y monitorear su estado, lo cual podría conllevar riesgos como la progresión de la caries, infecciones, problemas estéticos, o la necesidad de procedimientos más invasivos en el futuro.
        </p>

        <h2>Consentimiento y Autorización:</h2>
        <p style={normalTextStyle}>
          He recibido una explicación clara y comprensible sobre los riesgos, beneficios y posibles complicaciones del procedimiento de endodoncia. Acepto voluntariamente someterme a este procedimiento y autorizo al Dr. {doctor?.primerNombre || 'N/A'} {doctor?.segundoNombre || ''} {doctor?.primerApellido || 'N/A'} {doctor?.segundoApellido || ''} a realizar cualquier intervención adicional que sea necesaria para tratar cualquier complicación que pudiera surgir.
        </p>
