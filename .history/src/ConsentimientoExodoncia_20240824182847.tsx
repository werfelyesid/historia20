...
function ConsentimientoExodoncia({ doctor, patient }) {
  ...
  return (
    <>
      <button onClick={handlePrint} className="print-button">Imprimir</button> {/* Botón de imprimir agregado arriba */}
      <div id="consentimiento-print" className="consentimiento-form" ref={consentimientoRef}>
        ...
        <p style={normalTextStyle}>
          Se me ha explicado por parte del Dr. {doctor?.name || 'N/A'} que el procedimiento de exodoncia (extracción dental) consiste en la remoción de los dientes indicados para tratar afecciones dentales que no pueden ser resueltas con otros tratamientos conservadores. Este procedimiento implica la extracción de los dientes ({toothNumbers}), y se deben tomar precauciones específicas durante el período postoperatorio.
        </p>
        ...
        <ul style={normalTextStyle}>
          ...
          <li>Uso de antibióticos: Si el Dr. {doctor?.name || 'N/A'} ha prescrito antibióticos, debo completar el tratamiento según las indicaciones.</li>
        ...
        <ul style={normalTextStyle}>
          ...
          <li>Colaboración activa: Debo seguir todas las instrucciones proporcionadas por el Dr. {doctor?.name || 'N/A'} y asistir a todas las citas programadas.</li>
        ...
        <p style={normalTextStyle}>
          He recibido una explicación clara y comprensible acerca de los riesgos, beneficios y posibles complicaciones del procedimiento de exodoncia. Acepto voluntariamente someterme a este procedimiento y autorizo al Dr. {doctor?.name || 'N/A'} a realizar cualquier intervención adicional que sea necesaria para tratar cualquier complicación que pudiera surgir.
        </p>
      ...
      <button onClick={handlePrint} className="print-button">Imprimir</button> {/* Botón de imprimir agregado abajo */}
    </>
  );
}
