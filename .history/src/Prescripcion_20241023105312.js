...
const Prescripcion = () => {
  const { doctorUid, patientUid } = useParams(); // Obtener los parámetros de la URL
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const prescriptionDocRef = doc(db, 'doctors', doctorUid, 'pacientes', patientUid, 'prescripciones', timestamp);
