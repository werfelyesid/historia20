...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      await setDoc(doc(db, 'doctors', uid), { email }); // Guarda el email en el documento de 'users'
      await setDoc(doc(db, 'doctors', uid, ), doctor); // Guarda el perfil completo en la subcolección 'doctors'
