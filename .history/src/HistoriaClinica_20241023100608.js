...
return (
    <div>
      ...
      {selectedPatient && (
        <>
          <Link to={`/consentimientos/${doctorUid}/${selectedPatient.uid}/consentimientoOperatoria`}>
            <button>Ver Consentimiento Operatoria</button>
          </Link>
          <Link to={`/consentimientos/${doctorUid}/${selectedPatient.uid}/consentimientoCorona`}>
            <button>Ver Consentimiento Corona</button>
          </Link>
          <Link to={`/consentimientos/${doctorUid}/${selectedPatient.uid}/consentimientoExodoncia`}>
            <button>Ver Consentimiento Exodoncia</button>
          </Link>
          <Link to={`/consentimientos/${doctorUid}/${selectedPatient.uid}/consentimientoEndodoncia`}>
            <button>Ver Consentimiento Endodoncia</button>
          </Link>
          <Link to={`/consentimientos/${doctorUid}/${selectedPatient.uid}/consentimientoImplante`}>
            <button>Ver Consentimiento Implante</button>
          </Link>
          <Link to={`/consentimientos/${doctorUid}/${selectedPatient.uid}/consentimientoProtesis`}>
            <button>Ver Consentimiento Protesis</button>
          </Link>
          <Link to={`/consentimientos/${doctorUid}/${selectedPatient.uid}/consentimientoOrtodoncia`}>
            <button>Ver Consentimiento Ortodoncia</button>
          </Link>
          <Link to={`/prescripciones/${doctorUid}/${selectedPatient.uid}`}>
            <button>Ver Prescripciones</button>
          </Link>
          <Link to={`/odontograma/${doctorUid}/${selectedPatient.uid}`}>
            <button>Ver Odontograma</button>
          </Link>
        </>
      )}
      {/* Resto del contenido... */}
