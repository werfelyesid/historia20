...
const NuevoPaciente = ({ doctorId, onPatientAdded, onCancel }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const newPatientRef = await addDoc(collection(db, `doctors/${doctorId}/pacientes`), formData);
      ...
      await addEvolucion(doctorId, newPatientRef.id, descripcionEvolucion);
