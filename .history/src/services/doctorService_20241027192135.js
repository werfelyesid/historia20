...
// Función para crear un nuevo paciente y sus colecciones
export const crearNuevoPaciente = async (doctorUid, pacienteData) => {
  try {
    ...
    console.error('Error al crear nuevo paciente y colecciones:', error);
  }
};
