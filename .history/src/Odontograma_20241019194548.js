...
import Tooltip from './Tooltip'; // Importa el nuevo componente Tooltip
...
const Odontograma = () => {
      ...
      try {
        ...
        if (doctor) {
          ...
          if (doctorDoc.exists()) {
            ...
            console.error("No se encontraron datos del doctor.");
          }
        } else {
        ...
        console.error("Error al obtener los IDs del doctor y del paciente:", error);
      }
    };
  ...
  }, [doctorUid, patientUid, auth, navigate]);
